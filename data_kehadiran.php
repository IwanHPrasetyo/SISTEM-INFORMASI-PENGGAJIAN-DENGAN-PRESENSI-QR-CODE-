	...
	<body>
		<div class="pre-loader">
			<div class="pre-loader-box">
				<div class="loader-logo">
					<img src="src/images/logo_sekolah.png" alt="" />
				</div>
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							<span class="user-name">M. Sulaiman</span>
						</a>
						<div
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					<img src="src/images/logo_sekolah_small.png" alt="" class="dark-logo" />
					<img
					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								<span class="mtext"> Data Guru</span>
							</a>
							<ul class="submenu">
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">Data Kehadiran</h4>
							<p class="mb-0">
								Mastering data kehadiran
							</p>
						</div>
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
								<thead>
									<tr>
										<th class="table-plus datatable-nosort">ID Presensi</th>
										<th>Nama Guru</th>
										<th>Tanggal</th>
										<th>Jam</th>
										<th>Kelas</th>
								...
								<tbody>
									<tr>
										<td class="table-plus">PS001</td>
										<td>Moh. Sulaiman S.Pd</td>
										<td>21/05/2025</td>
										<td>07.00</td>
										<td>-</td>
										<td>
											<span class="badge badge-primary" data-bgcolor="#16a085">Harian</span>
										</td>
										<td>
											<span class="badge badge-primary" data-bgcolor="#f1c40f">Hadir</span>
										</td>
										<td>
											<div class="dropdown">
												<a
									...
									<tr>
										...
										<td>8</td>
										<td>
											<span class="badge badge-primary" data-bgcolor="#3498db">Pelajaran</span>
										</td>
										<td>
											<span class="badge badge-light">Tidak Hadir</span>
										</td>
										<td>
											<div class="dropdown">
												<a
